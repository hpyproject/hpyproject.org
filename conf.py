...
BLOG_AUTHOR = "The HPy Team"  # (translatable)
...
POSTS = (
    ...
    ("posts/*.md", "blog/posts", "post.tmpl"),
    ("posts/*.txt", "blog/posts", "post.tmpl"),
    ("posts/*.html", "blog/posts", "post.tmpl"),
)
PAGES = (
    ("pages/*.rst", "", "page.tmpl"),
    ("pages/*.md", "", "page.tmpl"),
...
# is in the manual.
COMMENT_SYSTEM_ID = "hpyproject/hpyproject.github.io"
